...
class AirQualityDatasetV2(Dataset):
    def __init__(
        self,
        rootdir: str,
...
class AirQualityDataModuleV2(LightningDataModule):
    def __init__(self,
        rootdir: str,
        normalize_mean: Dict[str, float],
        normalize_std: Dict[str, float],
    ...
    def setup(self, stage: Optional[str] = None):
        if self.split_mode == "timestamp":
            ...
            self.data_train = AirQualityDatasetV2(
                self.rootdir,
                self.normalize_mean,
                self.normalize_std,
                self.droprate,
            ...
            self.data_val = AirQualityDatasetV2(
                self.rootdir,
                self.normalize_mean,
                self.normalize_std,
                self.droprate,
